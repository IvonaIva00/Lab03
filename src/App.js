...
function NewsArticle(props) {
  ...
  const handleDelete = (e) => {
    ...
    if (target.tagName === "BUTTON" && target.textContent === "X") {
      e.currentTarget.remove();
    }
  };

  return (
    <div className="news_container" onClick={handleDelete}>
      <button className="close_container">X</button>
      <div className="story_header">
        ...
        <h1>
          ...
          <p className="story_creator">By: {props.creator}</p>
        </h1>
      </div>
